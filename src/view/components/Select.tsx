    ...
    <div>
      <div className="relative">
        ...
        >
          <RdxSelect.Trigger
            className={cn(
              "bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 focus:border-gray-800 transition-all outline-none text-left relative pt-4 disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed cursor-pointer",
              ...
              <RdxSelect.Viewport className="p-2">
                {options.map((option) => (
                  <RdxSelect.Item
                    key={option.value}
                    value={option.value}
                    className="p-2 text-gray-800 text-sm data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-300 rounded-lg transition-colors cursor-pointer hover:bg-gray-200"
                  >
