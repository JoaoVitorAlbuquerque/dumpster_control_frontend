  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button:
          "text-gray-700 cursor-pointer w-10 h-10 hover:bg-teal-100 rounded-full cursor-pointer",
      ...
      formatters={{
        formatCaption: (date, options) => {
          return (
            <span className="text-gray-900 tracking-[-0.408px] font-medium cursor-pointer">
